<div id="kt_app_sidebar" 
    ...
    >
    <!--begin::Logo-->
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" style="background: #000;">
        <!--begin::Logo image-->
        <a target="_blank" href="{{ url('/')}}">

                        
                              <img src="{{ url('img/LOGO CV-Full-Orange.gif') }}" alt="Logo" class=" app-sidebar-logo-default" style="height:60px" />
               
                              <img src="{{ url('img/LOGO CV-Full-Orange.gif') }}" alt="Logo" class="h-35px app-sidebar-logo-minimize" />
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ url('admin/category') }}">
                        ...
                        <span class="menu-title">หมวดหมู่เกมส์</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('admin/games') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">เกมส์ทั้งหมด</span>
                    </a>
                    <!--end:Menu link-->
                </div>
